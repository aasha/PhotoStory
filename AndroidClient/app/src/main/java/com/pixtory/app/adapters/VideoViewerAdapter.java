 ...
 */
public class VideoViewerAdapter extends PagerAdapter {
    ...
    private HashMap<Integer, VideoFragment> mFragmentPool = null;

    public VideoViewerAdapter(FragmentManager fm) {
        mFragmentManager = fm;
        mFragmentPool = new HashMap<Integer, VideoFragment>();
    }
    ...
    public Fragment getItem(int position) {
        try {
            ...
            VideoFragment hf = null;
            if (mFragmentPool.get(index) == null) {
                hf = VideoFragment.newInstance(pos);
